...
export class HttpServices {
    ...
    async sendPostRequest() {
        try {
            ...
            const errorResult = errorDebug(error.response.data, "httpServices.sendPostRequest()");
            return {
    ...
    async sendGetRequest() {
        try {
            ...
            const errorResult = errorDebug(error.response.data, "httpServices.sendGetRequest()");
            return {
                "statusCode": errorResult.statusCode,
                "responseBody": errorResult.responseBody
            }
    ...
    async sendPutRequest() {
        try {
            ...
            const errorResult = errorDebug(error.response.data, "httpServices.sendPutRequest()");
            return {
                "statusCode": errorResult.statusCode,
                "responseBody": errorResult.responseBody
            }
