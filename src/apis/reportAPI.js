...
export const ReportAPI = {
	...
	getAMReport:async function (reportData) {
		...
		httpService.URL =
			...
			&salesRep=${reportData?.salesRep}&searchText=${reportData?.searchText}&fromDate=${reportData?.fromDate}&toDate=${reportData?.toDate}&str_probabilityratio=${reportData?.str_probabilityratio}&str_weeknos=${reportData?.str_weeknos}`
