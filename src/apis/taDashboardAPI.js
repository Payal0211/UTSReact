...
export const TaDashboardAPI = {
	...
	getAllScrumHistoryListRequest: async function (payload) {
		...
		httpService.URL =
			NetworkInfo.NETWORK +
			SubDomain.TA_DASHBOARD +
			TaDashboardURL.GET_SCRUM_HISTORY_DETAILS +`?Year=${payload?.Year}&Month=${payload?.Month}&TAHeadUserID=${payload?.TAHeadUserID}&Tab_Name=${payload?.Tab_Name}`
	...
	updateScrumTaskColumnWidthRequest: async function (payload) {
		let httpService = new HttpServices();
		httpService.URL =
			NetworkInfo.NETWORK +
			SubDomain.TA_DASHBOARD +
			TaDashboardURL.UPDATE_SCRUM_COLUMN_WIDTH +`?POD_Id=${payload.POD_Id}&ColumnName=${payload.ColumnName}&ColumnWidth=${payload?.ColumnWidth}`
	...
	getHRTalentsWiseRecruiterInterviewDashboardReq:async function (pl) {
		...
		httpService.URL =
			NetworkInfo.NETWORK +
			SubDomain.REPORT +
			ReportsAPI.GET_INTERVIEW_WISE_RESCHEDULE_DESHBOARD + `?month=${pl?.month}&year=${pl?.year}&fromDate=${pl?.fromDate}&toDate=${pl?.toDate}&tAUserID=${pl?.tAUserID}&optiontype=${pl?.optiontype}`
		...
		try {
			...
			return errorDebug(error, 'TaDashboardAPI.getHRTalentsWiseRecruiterInterviewDashboardReq');
		}
	},
...
getPODTableDataRequest: async function (pl) {
		...
		httpService.URL =
			NetworkInfo.NETWORK +
			SubDomain.TA_DASHBOARD +
			TaDashboardURL.GET_SCRUM_POD_TABLE_DATA + `?Month=${pl?.Month}&Year=${pl?.Year}&TAHeadUserID=${pl?.TAHeadUserID}&Tab_Name=${pl?.Tab_Name}&Tab_Value=${pl?.Tab_Value}&ToDateStr=${pl?.ToDateStr}&FromDateStr=${pl?.FromDateStr }`
	...
	getTAProformanceTableDataRequest: async function (pl) {
		...
		httpService.URL =
			NetworkInfo.NETWORK +
			SubDomain.TA_DASHBOARD +
			TaDashboardURL.GET_SCRUM_TA_PERFORMANCE_TABLE_DATA + `?Month=${pl?.Month}&Year=${pl?.Year}&TAHeadUserID=${pl?.TAHeadUserID}&Tab_Name=${pl?.Tab_Name}&Tab_Value=${pl?.Tab_Value}&ToDateStr=${pl?.ToDateStr}&FromDateStr=${pl?.FromDateStr }`
	...
	getLogisticsTableDataRequest: async function (pl) {
		...
		httpService.URL =
			NetworkInfo.NETWORK +
			SubDomain.TA_DASHBOARD +
			TaDashboardURL.GET_SCRUM_LOGISTICS_TABLE_DATA + `?Month=${pl?.Month}&Year=${pl?.Year}&TAHeadUserID=${pl?.TAHeadUserID}&Tab_Name=${pl?.Tab_Name}&Tab_Value=${pl?.Tab_Value}&ToDateStr=${pl?.ToDateStr}&FromDateStr=${pl?.FromDateStr }`
