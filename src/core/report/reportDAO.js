...
export const ReportDAO = {
	...
	getJoiningRevenueDataDAO: async function (reportData) {
		try {
			const teamDemandSummary = await ReportAPI.getJoiningRevenueDataRequest(
				reportData
			);
			if (teamDemandSummary) {
				const statusCode = teamDemandSummary['statusCode'];
	...
	getALLPODJoiningRevenueDataDAO: async function (reportData) {
		try {
			const teamDemandSummary = await ReportAPI.getALLPODJoiningRevenueDataRequest(
				reportData
			);
			if (teamDemandSummary) {
				const statusCode = teamDemandSummary['statusCode'];
			...
			return errorDebug(error, 'ReportDAO.getALLPODJoiningRevenueDataDAOs');
		}
	},
	...
	getQOQReportDataDAO: async function (reportData) {
		try {
			const teamDemandSummary = await ReportAPI.getQOQReportDataRequest(
				reportData
			);
			if (teamDemandSummary) {
				const statusCode = teamDemandSummary['statusCode'];
			...
			return errorDebug(error, 'ReportDAO.getQOQReportDataDAOs');
		}
	},
	...
	getImmediateJoinerReportDAO: async function (reportData) {
		try {
			const replacementResult = await ReportAPI.getImmediateJoinerReport(
				reportData,
			);
			if (replacementResult) {
				const statusCode = replacementResult['statusCode'];
			...
			return errorDebug(error, 'ReportDAO.getImmediateJoinerReportDAO');
		}
	},
	getInterviewRescheduleDashboardReportDAO: async function (reportData) {
		try {
			const replacementResult = await ReportAPI.getInterviewRescheduleDashboardReport(
				reportData,
			);
			if (replacementResult) {
				const statusCode = replacementResult['statusCode'];
	...
	getAMSummeryReportDAO : async function (reportData) {
		try {
			const replacementResult = await ReportAPI.getSummeryAMReport(
				reportData,
			);
			if (replacementResult) {
				const statusCode = replacementResult['statusCode'];
	...
	PotentialOwnerUserDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.PotentialOwnerUserAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.PotentialOwnerUserDAO');
		}
	},	
	getALLPotentialClosuresCommentsDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getALLPotentialClosuresCommentsAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	insertPotentialClosureCommentRequestDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.insertPotentialClosuresCommentsAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.insertPotentialClosureCommentRequestDAO');
		}
	},
	getPotentialRemarkDAO: async function (payload) {
		try {
			const taResult = await ReportAPI.getPotentialRemarkAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getPotentialRemarkDAO');
		}
	},
	insertPotentialClosureResponseRequestDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.insertPotentialClosureResponseRequestAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.insertPotentialClosureResponseRequestDAO');
		}
	},
	...
	revenueWCGRCommentReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.revenueWCGRCommentReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.revenueWCGRCommentReportDAO');
		}
	},
	...
	getPOCPopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getPOCPopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getALLPOCPopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getAllPOCPopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getAllPOCPopupReportDAO');
		}
	},
	getReferencePopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getReferencePopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getReferencePopupReportDAO');
		}
	},
	getAnticipatedPopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getAnticipatedPopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getPopupForAllPODSDetailsDAO:async function (payload) {
		try {
			...
			return errorDebug(error, 'TaDashboardDAO.getPopupForAllPODSDetailsDAO');
		}
	},
	...
	getALLPOChrSummaryPopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getALLPOChrSummaryPopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getALLPOChrSummaryPopupReportDAO');
		}
	},
	getReferenceALLPODPopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getReferenceALLPODPopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getReferenceALLPODPopupReportDAO');
		}
	},
	...
	getDeliveryFunnelPopupMultiMonthReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getDeliveryFunnelPopupMultiMonthReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getDeliveryFunnelPopupMultiMonthReportDAO');
		}
	},
	getPOCDFPopupReportDAO:async function (payload) {
		try {
			...
			return errorDebug(error, 'TaDashboardDAO.getPOCDFPopupReportDAO');
		}
	},
	getNegotiationPopupReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getNegotiationPopupReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getNegotiationReportDAO:async function (payload) {
		try {
			...
			return errorDebug(error, 'TaDashboardDAO.getNegotiationReportDAO');
		}
	},
	getPtoNegotiationReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getPtoNegotiationReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getPlanningSummeryReportDAO:async function (payload) {
		try {
	...
	getJoinedSummeryReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getJoinedSummeryReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getFreezeSummeryReportDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getFreezeSummeryReportAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getPODWiseQuarterlySummaryDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getPODWiseQuarterlySummaryAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getPODWiseQuarterlySummaryDAO');
		}
	},
	getNegotiationReportSummaryDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getNegotiationReportSummaryAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	ScreenInterviewRejectCountsDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.ScreenInterviewRejectCountsAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.ScreenInterviewRejectCountsDAO');
		}
	},
	rejectedTalentsDetailsDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.rejectedTalentsDetailsAPI(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.rejectedTalentsDetailsDAO');
		}
	},
	AMWiseTalentInterviewDetailsDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.GetAMWiseTalentInterviewDetails(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.AMWiseTalentInterviewDetailsDAO');
		}
	},
		getAllPODGroupDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getAllPODGroupRequest(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
	...
	getAllPODRevenueDAO:async function (payload) {
		try {
			const taResult = await ReportAPI.getAllPODRevenueRequest(payload);
			if (taResult) {
				const statusCode = taResult['statusCode'];
				if (statusCode === HTTPStatusCode.OK) {
					const tempResult = taResult.responseBody;
			...
			return errorDebug(error, 'TaDashboardDAO.getAllPODRevenueDAO');
		}
	},
};
