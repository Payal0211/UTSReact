...
import './n_all_hiring_request.css';
    ...
    const TABLEBODYComponent = () => {
        ...
        return  <tbody>
            {apiData.map((data, index) => {
              return    <tr key={index + data?.HR_ID}>
                                ...
                                <td className="shortcuts-cell">
                                    <a href="#" className="shortcut-icon-wrapper" data-tooltip="Preview HR">
                                        <img src="images/preview-hr-ic.svg" alt="Preview HR" className="shortcut-icon" />
                                    </a>
                                    <a href="#" className="shortcut-icon-wrapper" data-tooltip="Close HR">
                                        <img src="images/close-hr-ic.svg" alt="Close HR" className="shortcut-icon" />
                                    </a>
                                    <a href="#" className="shortcut-icon-wrapper" data-tooltip="Clone HR">
                                        <img src="images/clone-hr-ic.svg" alt="Clone HR" className="shortcut-icon" />
                                    </a>
                                    <a href="#" className="shortcut-icon-wrapper" data-tooltip="Split HR">
                                        <img src="images/split-hr-ic.svg" alt="Split HR" className="shortcut-icon" />
                                    </a>
                                </td>
                                {/* CREATED DATE */}
                                <td>{data?.Date}</td>
                                {/* HR ID */}
                                <td>
                                    <a href={`/allhiringrequest/${data?.key}`} className="hr-id">{data?.HR_ID}</a>
            ...
            marginTop:'2px'
                                    ...
                                    {/* <span className="hr-id-status hr-status-open">via Workspace</span> */}
                                </td>
                                {/* COMPANY */}
                                <td>{data?.Company}</td>
                                {/* POSITION */}
                                ...
                                <td>
                                    <div className="category-cell-wrapper">
                                        {/* <div className="category-left"> */}
                                            {/* <button type="button" className="diamond-toggle" data-tooltip="Remove Diamond"> */}
                                             {data?.companyCategory === "Diamond" ? <img src="images/diamond-active-ic.svg" alt="Diamond Active" className="diamond-icon diamond-active" /> : <img src="images/diamond-ic.svg" alt="Diamond" className="diamond-icon diamond-inactive" />}   
                                                
                                            {/* </button> */}
                                        {/* </div> */}
                                        <div className="category-divider"></div>
                                        <div className="category-right">
                                           {data?.hR_Category === '' ? <div className="archetype-select-wrapper" >
                                                <button type="button" className="archetype-btn">Archetype</button>
                                                <div className="archetype-dropdown">
                                                    <button type="button" className="archetype-option" data-value="kitten">
                                                        <img src="images/kitten-ic.svg" alt="Kitten" /> Kitten
                                                    </button>
                                                    <button type="button" className="archetype-option" data-value="cheetah">
                                                        <img src="images/cheetah-ic.svg" alt="Cheetah" /> Cheetah
                                                    </button>
                                                    <button type="button" className="archetype-option" data-value="panda">
                                                        <img src="images/panda-ic.svg" alt="Panda" /> Panda
                                                    </button>
                                                </div>
                                            </div> : <div className="archetype-image-wrapper">
                                                <div className="archetype-image-container">
                                                  {data?.hR_Category === 'Cheetah' &&  <img src="images/cheetah-ic.svg" alt="Cheetah" class="archetype-image" />} 
                                                       {data?.hR_Category === 'Panda' && <img src="images/panda-ic.svg" alt="Panda" class="archetype-image" />}  
                                                       {data?.hR_Category === 'Kitten' && <img src="images/kitten-ic.svg" alt="Kitten" className="archetype-image" />}    
                                                </div>
                                                <button type="button" className="archetype-close">×</button>
                                            </div>} 
                                ...
                                <td>{data?.hrEngagementType} 
                                    {/* <span className="transparent-text">(Transparent)</span> */}</td>
                                {/* MARGIN % */}
                                <td>{data?.timeZone}</td>
                                ...
                                <td>
                                    ...
                                    {/* <span className="hr-status-badge hr-status-open">Open</span> */}
                                    </td>
                                {/* FTE/PTE */}
            ...
            <div className="content-wrapper">
                ...
                <div className="filter-controls">
                    <div className="filter-group">
                        <input type="text" className="filter-input date-input" placeholder="Select Date Range" />
                        <img src="images/calendar-ic.svg" alt="Calendar Icon" className="input-icon" />
                    </div>
                    <div className="filter-group search-group">
                        <input type="text" className="filter-input search-input" placeholder="Search via HR#, role, company" />
                        <img src="images/search-ic.svg" alt="Search Icon" className="input-icon" />
                    </div>
                    <button className="filter-btn">
                        <span>Add Filters</span>
                        <img src="images/filter-ic.svg" alt="Filter Icon" />
                    </button>
                    <div className="filter-group control-btns-group">
                        <button className="btn-add-hr control-btns">ADD NEW HR</button>
                        <button className="btn-export control-btns"   onClick={() => handleExport(apiData)}>Export</button>
                    </div>
                </div>
                        ...
                        <div className="pagination-right">
                            <div className="per-page-container">
                                ...
                                <div className="select-wrapper">
                                    <select className="rows-select" value={pageSize} onChange={(e)=>{
                            ...
                            <span className="pagination-info">1-10 of {totalRecords}</span>
