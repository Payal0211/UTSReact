                    ...
                    <div className={UserFieldStyle.hrFieldRightPane}>
                        ...
                        <div className={UserFieldStyle.row}>
                            <div className={UserFieldStyle.colMd12}>
                                <div className={`${UserFieldStyle.radioFormGroup} ${UserFieldStyle.newUserRadioGroup}`}>
                                    <label>
                                        Is the User New?
                        ...
                        <div className={UserFieldStyle.row}>
                            <div className={UserFieldStyle.colMd12}>
                                <div className={UserFieldStyle.infoNotes}>
                                    Note: The Below Information would be available to view for you Talent/Client
                                </div>
                            </div>
                        </div>
            ...
            <div className={UserFieldStyle.partOne}>
                ...
                <div className={UserFieldStyle.hrFieldRightPane}>
                    <div className={UserFieldStyle.formPanelAction}>
                        ...
                        <button onClick={handleSubmit(hrSubmitHandler)} className={UserFieldStyle.btn}>
                            Back to Users
                        </button>
                    </div>
                </div>
