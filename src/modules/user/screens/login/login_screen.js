	...
	const loginHandler = useCallback(
		async (d) => {
			...
			if (result.statusCode === HTTPStatusCode.OK) {
				setLoading(false);
				navigate(isAccess(result.responseBody.LoggedInUserTypeID) ? result.responseBody.LoggedInUserTypeID === (6 && 3) ? UTSRoutes.AMDASHBOARD :  UTSRoutes.ALLHIRINGREQUESTROUTE : UTSRoutes.DASHBOARD);
