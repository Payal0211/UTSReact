...
export default function PotentialClosuresSheet() {
    ...
    }, [activeTab,openTicketSearchText])
             ...
             <div className={pcsStyles.filterContainer}>
                <div className={pcsStyles.filterSets}>
                    <div className={pcsStyles.filterSetsInner}>
                        <div className={pcsStyles.searchFilterSet} style={{marginLeft:'10px'}}>
                    ...
                    <div className={pcsStyles.paginationFilter} style={{ border: "none", width: "auto" }}>
                        <button className={pcsStyles.btnPrimary}  onClick={() =>handleExport(data)}>Export</button>
                    </div>  
                    </div>             
                </div>                    
            </div>
