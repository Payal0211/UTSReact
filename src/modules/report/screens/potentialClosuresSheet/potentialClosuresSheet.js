...
const columns = [
    ...
    {
        title: 'Open since how many days',
    ...
    {
        title: 'Talent Pay Rate/ Client Budget (Format: USD)',
    ...
    {
        title: 'Talent Pay Rate/ Client Budget (Annual CTC)',
    ...
    {
        title: 'Uplers Fees / Month (TR/Emp)',
