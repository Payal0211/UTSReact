...
const AMReport = () => {
  ...
  const getAMReportData = async () => {
    let payload = {
      ...
      "fromDate": dateTypeFilter === 2 ? '' : dateTypeFilter === 1 ?  moment(startDate).format('DD/MM/YYYY') : '',
      "toDate": dateTypeFilter === 2 ? '' : dateTypeFilter === 1 ?  moment(endDate).format('DD/MM/YYYY'): '' ,
