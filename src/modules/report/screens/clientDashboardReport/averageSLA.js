...
export default function AverageSlA() {  
  ...
  const tableColumnsMemo = useMemo(() => {
    return [
      ...
      {
        title:  <>HRSubmission to <br/> Matchmaking</>,
        dataIndex: "hrSubmission_to_Matchmaking",
        key: "hrSubmission_to_Matchmaking",
        align: "center",
        width: "120px",
        render: (text, result) => {
      ...
      {
        title: <>Matchmaking to  <br/>R1Interview </>,
        dataIndex: "matchmaking_to_R1Interview",
        key: "matchmaking_to_R1Interview",
        align: "center",
       width: "120px",
        render: (text, result) => {
           return   text ? text : ''
      ...
      {
        title:  <>R1Interview to  <br/>R2Interview </>,
        dataIndex: "r1Interview_to_R2Interview",
        key: "r1Interview_to_R2Interview",
        align: "center",
        width: "120px",
        render: (text, result) => {
          return   text ? text : ''
    ...
    {
        title: <>R2Interview to  <br/>R3Interview </>,
        dataIndex: "r2Interview_to_R3Interview",
        key: "r2Interview_to_R3Interview",
        align: "center",
        width: "120px",
        render: (text, result) => {
          return   text ? text : ''
    ...
    {
        title: <>R2orR3 Interview <br/> to Offer </>,
        dataIndex: "r2orR3Interview_to_Offer",
        key: "r2orR3Interview_to_Offer",
        align: "center",
        width: "120px",
        render: (text, result) => {
          return   text ? text : ''
    ...
    {
        title: "Total AverageSLA",
        dataIndex: "total_AverageSLA",
        key: "total_AverageSLA",
        align: "center",
        width: "120px",
        render: (text, result) => {
          return   text ? text : ''
  ...
  const getDashboardReport = async () => {
    ...
    setLoading(true)
    const apiResult = await ReportDAO.getAverageSLAdReportDAO(payload);
    setLoading(false)
  ...
  const handleExport = (apiData) => {
      let DataToExport =  apiData.map(data => {
          ...
          tableColumnsMemo.forEach(val => {  
            if(val.key ==='hrSubmission_to_Matchmaking')  {
              obj[`HRSubmission to Matchmaking`] = data[`${val.key}`]            
            } else if(val.key ==='matchmaking_to_R1Interview')  {
              obj[`Matchmaking to R1Interview`] = data[`${val.key}`]  
            }  else if(val.key ==='r1Interview_to_R2Interview')  {
              obj[`R1Interview to R2Interview `] = data[`${val.key}`]  
            }  else if(val.key ==='r2Interview_to_R3Interview')  {
              obj[`R2Interview to R3Interview`] = data[`${val.key}`]  
            }  else if(val.key ==='r2orR3Interview_to_Offer')  {
              obj[`R2orR3 Interview to Offer`] = data[`${val.key}`]  
            } else{
      ...
      downloadToExcel(DataToExport,'Average SLA')  
  }
  ...
  return (
    <div className={clientDashboardStyles.hiringRequestContainer}>
      ...
      <div className={clientDashboardStyles.addnewHR} style={{ margin: "0" }}>
        <div className={clientDashboardStyles.hiringRequest}>Recruiter Average SLA Report</div>
      </div>
