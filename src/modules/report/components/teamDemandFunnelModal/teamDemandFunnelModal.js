...
const TeamDemandFunnelModal = ({
	...
	const getSupplyFunnelHRDetailHandler = useCallback(async () => {
		const response = await ReportDAO.teamDemandFunnelHRDetailsRequestDAO(
			demandFunnelHRDetailsState,
		);
...
export default TeamDemandFunnelModal;
