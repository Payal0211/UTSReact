						...
						<ul>
							<li>
								...
								<div className={dealDetailsStyles.dealActivityInfo}>
									...
									<p>
										“Call done in the month of Oct 2022, sent a couple of emails
										and the client mentioned he is busy and will get back to us.
										We will approach again in the month of Jan 2023.”
									</p>
								</div>
							</li>
							<li>
							...
							<li>
								...
								<div className={dealDetailsStyles.dealActivityInfo}>
									<p>
										<span>
											Moved deal from Discovery call Scheduled to Discover call
											Rescheduled.
										</span>
									</p>
									<p className={dealDetailsStyles.dealActivityAction}>
