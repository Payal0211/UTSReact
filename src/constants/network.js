...
export class TaDashboardURL {
	...
	static GET_ALL_MASTER_FTE_Data = 'GetAllMastersData_FTE'
...
export class ReportType {
	...
	static AM_WEEK_WISE_REPORT_NEW =  'AMWeekWiseReportNew'
	static AM_WEEK_WISE_REPORT_FILTERS = 'AMWeekWiseReportFilters'
	static AM_WISE_CLOSURES_SUMMARY = 'AMWisePotentialClosuresSummary'
	...
	static GET_POD_DASHBOARD_MONTH_LIST = 'PODDashboardForMutipleMonths'
	...
	static GET_ALL_CUSTOMER_FUNNEL_POPUP_DETAILS_LIST = "Get_WCGR_AllFTE_NewCustomerFunnel_Popup_Report"
	...
	static GET_JOINED_SUMMARY_REPORT = 'PODwiseAnticipatedvsActualJoinedSummary'
...
export class MastersAPI {
	...
	static UPDATE_REFERENCE_DETAILS = 'AddSalesHRRef';
...
export class HiringRequestsAPI {
	...
	static UPDATE_HR_CATEGORY = 'UpdateHRCategory';
